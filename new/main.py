...
### extract features ###
########################
# extract_features.py takes the output of extract predicate and argument as an argument
# and creates new file with all features
# this might take a while because of the size of the training file
...
os.system("python SVM_new.py data/train__all_features data/test__all_features")
